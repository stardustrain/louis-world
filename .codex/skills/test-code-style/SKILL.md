...
description: Use when writing or modifying test code, creating test files, adding test cases, or designing tests for exported functions.
---
...
---
name: test-code-style
description: 테스트 코드 작성, test 파일 생성, 테스트 케이스 추가 시 반드시 적용해야 하는 테스트 코드 스타일 가이드라인. 모든 테스트 코드 작업에 이 스킬을 사용하세요.
---
