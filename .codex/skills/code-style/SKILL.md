---
name: code-style
description: Use when modifying, reviewing, refactoring, testing, or designing source code, runtime behavior, APIs, data models, software architecture, or technical implementation approaches.
---
...
The test: Every changed line, component, pattern, and architecture choice should trace directly to the user's request.
